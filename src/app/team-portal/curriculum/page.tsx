...
export default function CurriculumEditor() {
  ...
  const fetchCurriculumData = async () => {
    ...
    if (isRealSupabase && supabase) {
      ...
      setCourses([
        { id: "builder-c2", title: "Microcontroller Essentials (Sandbox)", path_level: "builder" }
      ]);
      setLessons([
        { id: "builder-l1", course_id: "builder-c2", title: "Led Loop Setup", sequence_number: 1 }
      ]);
      setSelectedCourseId("builder-c2");
    }
    setLoading(false);
  };
  ...
  const handleAddLesson = async (e: React.FormEvent) => {
    ...
    if (isRealSupabase && supabase) {
      ...
      setLessons([...lessons, newLess]);
      setNewLessonId("");
      setNewTitle("");
      alert("Lesson added in sandbox mode successfully!");
    }
