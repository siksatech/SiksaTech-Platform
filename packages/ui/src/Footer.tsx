...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0A0F1D] text-slate-300 pt-20 pb-12 border-t border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Main Footer Grid: Brand Area (35%) + 4 Navigation Columns (65%) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 pb-16">
          {/* Brand Column (Wide 35% layout on desktop, balanced paragraph) */}
          <div className="lg:col-span-4 xl:col-span-5 space-y-6">
            <Link href="/" className="inline-flex items-center gap-3 group">
              <SiksaTechLogo size={44} className="h-10 w-auto" />
          ...
          <div className="lg:col-span-8 xl:col-span-7 grid grid-cols-2 sm:grid-cols-4 gap-8 sm:gap-6">
            {/* Learning Column */}
        ...
        <div className="border-t border-slate-800/80 py-8 flex items-center justify-center">
          <p className="text-xs sm:text-sm font-medium text-slate-500 tracking-wide text-center">
