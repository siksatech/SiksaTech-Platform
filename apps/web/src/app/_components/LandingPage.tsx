                ...
                {faqs.map((faq) => (
                  <div key={faq.id} className="border border-slate-200 rounded-xl overflow-hidden">
                    ...
                    >
                      ...
                      <ChevronDown className={`w-5 h-5 text-slate-500 transition-transform ${openFaq === faq.id ? "rotate-180" : ""}`} />
                    </button>
                    {openFaq === faq.id && (
        ...
        <section className="py-20 bg-blue-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
            ...
            <p className="text-lg text-blue-100">
              Join thousands of students learning electronics, coding, and engineering the right way — by building real things.
            </p>
            <Link
              href="/auth/register"
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-blue-600 hover:bg-blue-50 font-bold text-base rounded-xl transition-all shadow-md"
            >
